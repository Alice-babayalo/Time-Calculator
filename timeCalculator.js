...
if(differenceInHours <1){
  console.log(durationAnalysis.minuteAnalysis(differenceInHours));
}
else if (differenceInHours>=1 && differenceInHours <24){
  console.log(durationAnalysis.hoursAnalysis(differenceInHours));
}
else if(difference >= 24){
  console.log(durationAnalysis.dayAnalysis(differenceInHours));
}
